...
export default function PrivacyPage() {
  return (
    <section className="container max-w-4xl py-10 md:py-14">
      <p className="section-kicker">Última actualización: 22 de julio de 2026</p>
      ...
      <div className="mt-8 space-y-8 leading-8 text-neutral-700">
        <p>
          En AKTUA HOME estamos comprometidos con la protección de los datos personales de nuestros clientes, propietarios, compradores, arrendadores, arrendatarios y usuarios de nuestra página web.
        </p>
        <p>
        ...
        <LegalSection title="4. Legitimación">
          <LegalList
            items={[
              ...
              "El cumplimiento de obligaciónes legales.",
              "El interés legítimo de AKTUA HOME para mejorar la atención al cliente y la prestación de sus servicios."
            ]}
          />
        </LegalSection>
        ...
        <LegalSection title="6. Destinatarios de los datos">
          ...
          />
          <p>En ningún caso AKTUA HOME venderá, alquilará o cederá datos personales con fines comerciales.</p>
        </LegalSection>

        <LegalSection title="7. Transferencias internacionales">
          <p>Con carácter general, AKTUA HOME no realiza transferencias internacionales de datos.</p>
          <p>No obstante, algunos proveedores tecnológicos, como servicios de correo electrónico, almacenamiento en la nube o herramientas de análisis, pueden tratar información fuera del Espacio Económico Europeo, aplicando las garantías previstas por el RGPD.</p>
        </LegalSection>
        ...
        <LegalSection title="8. Derechos de los interesados">
          ...
          />
          <p>Para ejercer estos derechos puede enviar una solicitud a: aktuahome@gmail.com.</p>
          <p>La solicitud deberá ir acompañada de un documento que permita acreditar su identidad cuando resulte necesario.</p>
          <p>Asimismo, podrá presentar una reclamación ante la Agencia Española de Protección de Datos (www.aepd.es) si considera que el tratamiento de sus datos no se ajusta a la normativa vigente.</p>
        </LegalSection>

        <LegalSection title="9. Medidas de seguridad">
          <p>AKTUA HOME adopta las medidas técnicas y organizativas necesarias para garantizar la confidencialidad, integridad y disponibilidad de los datos personales, evitando su alteración, pérdida, tratamiento o acceso no autorizado.</p>
        </LegalSection>

        <LegalSection title="10. Comunicaciones comerciales">
          <p>Solo enviaremos información comercial cuando exista consentimiento del interesado, o exista una relación contractual previa y las comunicaciones se refieran a servicios similares a los contratados, conforme a la legislación vigente.</p>
          <p>El usuario podrá darse de baja en cualquier momento enviando un correo electrónico a: aktuahome@gmail.com.</p>
        </LegalSection>

        <LegalSection title="11. Redes sociales">
          <p>AKTUA HOME dispone de perfiles en diferentes redes sociales.</p>
          <p>Las interacciones realizadas a través de dichas plataformas estarán sujetas tanto a esta Política de Privacidad como a las políticas de privacidad propias de cada red social.</p>
        </LegalSection>
